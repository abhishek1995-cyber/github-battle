    ...
    render(){
      if(this.state.isOpen == true){
        return (
            ...
            <h4>Location:{this.state.winner.location}</h4>
            ...
            <h4>Location:{this.state.looser.location}</h4>
                    ...
                    <h2>Player One</h2>
                     ...
                     {this.state.userOne && (
                        <div className="flex battle-user">
                            <img src={this.state.userOne.avatar_url}/>
                            <h5 className="battle-user-name">
                                {this.state.userOne.login}
                            </h5>
                            <button onClick={this.handleDeleteOne}
                            >X</button>
                        </div>
                      ...
                      <button className="player-btn"
                       onClick={this.handleTwo}>
                        Submit
                              ...
                              {this.state.userTwo && (
                        <div className="flex battle-user">
                            <img src={this.state.userTwo.avatar_url}/>
                            <h5 className="battle-user-name">
                                {this.state.userTwo.login}
                            </h5>
                            <button onClick={this.handleDeleteTwo}
                            >X</button>
                        </div>
